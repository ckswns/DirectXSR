...
class LightningBreath : public Behaviour
{
public:		explicit		LightningBreath(void) = delete;
public:		explicit		LightningBreath(D3DXVECTOR3 pos, D3DXVECTOR3 vDir, int dir);
