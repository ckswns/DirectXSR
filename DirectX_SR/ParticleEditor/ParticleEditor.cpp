...
// ParticleEditor.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
BEGIN_MESSAGE_MAP(CParticleEditorApp, CWinApp)
...
// CParticleEditorApp 생성

CParticleEditorApp::CParticleEditorApp() noexcept
{
	// 다시 시작 관리자 지원
...
// 유일한 CParticleEditorApp 개체입니다.

CParticleEditorApp theApp;


// CParticleEditorApp 초기화
